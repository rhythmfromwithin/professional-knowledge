...
> 原文: [https://medium.com/airbnb-engineering/the-guest-journey-updated-in-real-time-extending-airbnbs-sequence-recommender-with-chronon-8f1582578553?source=rss----53c7c27702d5---4](https://medium.com/airbnb-engineering/the-guest-journey-updated-in-real-time-extending-airbnbs-sequence-recommender-with-chronon-8f1582578553?source=rss----53c7c27702d5---4)
...
![A group of friends stand arm-in-arm along a riverbank at sunset, framed by tall eucalyptus trees, watching the golden sun reflect off calm water in a rural landscape.](https://cdn-images-1.medium.com/max/1024/1*PB9ohGH_82OBz6yYLkqPWQ.jpeg)

**By**: [Pengyu Hou](https://www.linkedin.com/in/pengyuhou/), [Yuli Han](https://www.linkedin.com/in/yulihan/), [Daochen Zha](https://www.linkedin.com/in/daochen-zha/), [Haozhen Ding](https://www.linkedin.com/in/haozhen-ding-23357966/), [Xin Liu](https://www.linkedin.com/in/xin-liu-908b6b18/), [Sophie Wang](https://www.linkedin.com/in/yuwang41/), [Pallavi Adusumilli](https://www.linkedin.com/in/pallaviadusumilli/), [Sherry Li](https://www.linkedin.com/in/shiying-li-7688ab137/), [Henry Saputra](https://www.linkedin.com/in/henrysaputra/), [Chun How Tan](https://www.linkedin.com/in/chunhowt/), [Huiji Gao](https://www.linkedin.com/in/huiji-gao/), [Yan Zhang](https://www.linkedin.com/in/yan-zhang-2471327a/), [Stephanie Moyerman](https://www.linkedin.com/in/stephanie-moyerman/), [Yi Li](https://www.linkedin.com/in/yi-li-755a6b24/), and [Sanjeev Katariya](https://www.linkedin.com/in/sanjeevkatariya/)

A guest’s interaction with Airbnb doesn’t pause to wait for a nightly batch job. Someone might browse a dozen listings on a Tuesday afternoon, run a new search that evening, and expect the next search to reflect the recent activity; it’s also to Airbnb’s benefit for that to be the case. In our previous post, [Personalizing Airbnb search by learning from the guest journey](https://medium.com/airbnb-engineering/personalizing-airbnb-search-by-learning-from-the-guest-journey-bcefd1915624), we described how we built a Transformer-based sequence encoder that creates better, more personalized search rankings for a guest using the booking, review, and browsing data that is most relevant to them — their own. That system ran as a daily batch job: each night it processed the previous day’s activity and refreshed embeddings for guests who had something new to show for it.
...
In this post, we describe how we closed that gap by adding two new capabilities to [Chronon](https://chronon.ai/), Airbnb’s feature platform: Near-real-time Model Transform and Push Mode. Chronon is an open source project, and these capabilities have been contributed back to our [public repo](https://github.com/airbnb/chronon/).
...
![Diagram of a two-stage ML pipeline: batch inference encodes guest activity sequences (bookings, views, cancellations) into embeddings, which feed a real-time ranking model that scores search results for a query.](https://cdn-images-1.medium.com/max/1024/1*5MTtUcsW09qOTV1TLindJg.png)
...
![Diagram titled ‘Chronon model transform’ showing two data paths — a near real-time path (Streaming events → Chronon NRT) and an offline batch path (Batch source → Chronon backfill) — both feeding into a Model transform stage that runs a sequence encoder to produce embeddings. The embeddings flow into a Feature store, then to Serving, which now powers search ranking.](https://cdn-images-1.medium.com/max/1024/1*D5O2dN3U8LeUoYOqcMbcNQ.png)
...
You can learn more about our team’s work on personalization and search ranking by checking out our previous post on [sequence modeling the guest journey](https://medium.com/airbnb-engineering/personalizing-airbnb-search-by-learning-from-the-guest-journey-bcefd1915624) and other engineering blog posts from Airbnb. To learn more about Chronon, check out our previous [blog posts](https://medium.com/airbnb-engineering/chronon-airbnbs-ml-feature-platform-is-now-open-source-d9c4dba859e8) on the project, and browse the code at our repo: <https://github.com/airbnb/chronon>.
...
![](https://medium.com/_/stat?event=post.clientViewed&referrerSource=full_rss&postId=8f1582578553)

---

[The guest journey, updated in real time: extending Airbnb’s sequence recommender with Chronon](https://medium.com/airbnb-engineering/the-guest-journey-updated-in-real-time-extending-airbnbs-sequence-recommender-with-chronon-8f1582578553) was originally published in [The Airbnb Tech Blog](https://medium.com/airbnb-engineering) on Medium, where people are continuing the conversation by highlighting and responding to this story.
