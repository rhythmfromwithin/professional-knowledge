---
interest: medium
link: https://medium.com/airbnb-engineering/my-journey-to-airbnb-anna-sulkina-85216183d094?source=rss
next_step: skim
slack_ts: '1773196777.563379'
...
> 原文: [https://medium.com/airbnb-engineering/my-journey-to-airbnb-anna-sulkina-85216183d094?source=rss----53c7c27702d5---4](https://medium.com/airbnb-engineering/my-journey-to-airbnb-anna-sulkina-85216183d094?source=rss----53c7c27702d5---4)

![](https://cdn-images-1.medium.com/max/1024/1*eiZyGBIJvx3S5kREFK8wOw.jpeg)
...
![](https://cdn-images-1.medium.com/max/506/1*S83sUpA6MqrQZ3ToqkXixg.jpeg)
...
I often think back to [How Complex Systems Fail](https://how.complexsystems.fail/) — the more complex a system, the more likely it is to fail. I remembered that lesson every time we were called to the Twitter command center to deal with an incident; it was all hands on deck until everything was back online.

The cultural lesson was about adoption and what it takes to fuel great ideas.

Today, [almost two-thirds of enterprises](https://thenewstack.io/graphql-growth-explodes-but-so-do-problems-federated-graphs-solve/) use GraphQL in production, but in its early days, it was a new, largely untested idea. During a hack week, a couple of engineers laid the groundwork for using this technology at Twitter. I worked closely with them and bootstrapped the team that eventually built Twitter’s GraphQL API, replacing the legacy REST services.
...
I’m happy this path, as unpredictable as it has been, has taken me to Airbnb. Airbnb is in that ideal position between a startup and a long-established company. The systems and workflows are mature, but there are still many interesting problems to solve and opportunities to pursue. If that’s of interest to you, I encourage you to check out [openings](http://careers.airbnb.com/) at Airbnb.

![](https://medium.com/_/stat?event=post.clientViewed&referrerSource=full_rss&postId=85216183d094)

---

[My Journey to Airbnb — Anna Sulkina](https://medium.com/airbnb-engineering/my-journey-to-airbnb-anna-sulkina-85216183d094) was originally published in [The Airbnb Tech Blog](https://medium.com/airbnb-engineering) on Medium, where people are continuing the conversation by highlighting and responding to this story.
